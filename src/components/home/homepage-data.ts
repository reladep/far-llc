...
export const pricingTiers: PricingTier[] = [
  {
    ...
    price: '$99',
    note: '/ 2 weeks',
    description: 'Full platform access with no recurring commitment. Try everything for two weeks — upgrade anytime.',
    features: [
    ...
    href: '/auth/signup?plan=trial',
  },
  {
    name: 'Consumer',
    price: '$199',
    note: '/ year',
    description: 'Year-round research, monitoring, and advisor matching — the core product for serious investors.',
    features: [
      'Everything in Trial',
    ...
    ctaLabel: 'Get Consumer Access',
    href: '/auth/signup?plan=consumer',
    featured: true,
  },
  {
    name: 'Enterprise',
    price: '$499',
    note: '/ year',
    description: 'For power users and institutions who need scale, speed, and deeper integration.',
    features: [
